...
//Declaracion de variables
	//Bandera
		...
		bool con=true;
	//Variables
		int entrada=0; //Numero a ingresar
		int entradaAux = 0; //Validacion de continuacion
		int tamArr=0;  //Tamaño del arreglo
		int tamArrAct=0;  //Buscar el tamaño del arreglo
	//Arreglos
		//int numeros[tamArr];
	//Fors
		int iimp=0;
...
//Impresiones
int imprimir(int impNum[]){  for(iimp=0;iimp<6;iimp++)  cout<<impNum[iimp]<<" "; }
